/* autogenerated by Processing revision 1283 on 2022-09-16 */
...
public class LSystemMath 
{
 ...
 public void branch(float h, float minlength, float scaling, float bottomAngle, float topAngle, int minBranchesm, int maxBranches, float widthFactor) 
{
...
bottomAngle /= scaling;
 ...
 public void newTree(float length, float minlength, float scaling, int maxAngle,int minBranchesm,int maxBranches, float widthFactor) 
{
