...
void branch(PGraphics object, float h, float minlength, float scaling, float bottomAngle, float topAngle, int minBranchesm, int maxBranches, float widthFactor) 
{
...
void newTree(PGraphics object, float length, float minlength, float scaling, int maxAngle,int minBranchesm,int maxBranches, float widthFactor) 
{
